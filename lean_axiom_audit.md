...
- Rows matching the canonical baseline: `63`
...
| `lem:one-step-drift-kernel` | `SemanticConvergence.lem_one_step_drift_kernel` | `['propext', 'Classical.choice', 'Quot.sound', 'SemanticConvergence.listWeightedSum_ne_zero_exists._native.native_decide.ax_1_2']` |
...
| `lem:prior-invariance` | `lemma` | `SemanticConvergence.Belief` | `SemanticConvergence.lem_prior_invariance` | `substantive` | `canonical-baseline` | `['propext', 'Classical.choice', 'Quot.sound']` | `yes` |
...
| `lem:odds-identity` | `lemma` | `SemanticConvergence.Semantic` | `SemanticConvergence.lem_odds_identity` | `substantive` | `expected-native-decide-auxiliary` | `['propext', 'Classical.choice', 'Quot.sound', 'SemanticConvergence.listWeightedSum_ne_zero_exists._native.native_decide.ax_1_2']` | `no` |
...
| `lem:zero-criterion` | `lemma` | `SemanticConvergence.Semantic` | `SemanticConvergence.lem_zero_criterion` | `substantive` | `expected-native-decide-auxiliary` | `['propext', 'Classical.choice', 'Quot.sound', 'SemanticConvergence.listWeightedSum_ne_zero_exists._native.native_decide.ax_1_2']` | `no` |
| `prop:chernoff-correspondence` | `proposition` | `SemanticConvergence.Semantic` | `SemanticConvergence.prop_chernoff_correspondence` | `substantive` | `expected-native-decide-auxiliary` | `['propext', 'Classical.choice', 'Quot.sound', 'SemanticConvergence.listWeightedSum_ne_zero_exists._native.native_decide.ax_1_2']` | `no` |
...
| `thm:separating-support-convergence` | `theorem` | `SemanticConvergence.Semantic` | `SemanticConvergence.thm_separating_support_convergence` | `constructive-existential` | `expected-native-decide-auxiliary` | `['propext', 'Classical.choice', 'Quot.sound', 'SemanticConvergence.listWeightedSum_ne_zero_exists._native.native_decide.ax_1_2']` | `no` |
...
| `thm:separating-support-rate` | `theorem` | `SemanticConvergence.Semantic` | `SemanticConvergence.thm_separating_support_rate` | `constructive-existential` | `expected-native-decide-auxiliary` | `['propext', 'Classical.choice', 'Quot.sound', 'SemanticConvergence.listWeightedSum_ne_zero_exists._native.native_decide.ax_1_2']` | `no` |
| `cor:separating-support-finite-time` | `corollary` | `SemanticConvergence.Semantic` | `SemanticConvergence.cor_separating_support_finite_time` | `constructive-existential` | `expected-native-decide-auxiliary` | `['propext', 'Classical.choice', 'Quot.sound', 'SemanticConvergence.listWeightedSum_ne_zero_exists._native.native_decide.ax_1_2']` | `no` |
...
| `lem:one-step-drift` | `lemma` | `SemanticConvergence.Rates` | `SemanticConvergence.lem_one_step_drift` | `rate-composition` | `expected-native-decide-auxiliary` | `['propext', 'Classical.choice', 'Quot.sound', 'SemanticConvergence.listWeightedSum_ne_zero_exists._native.native_decide.ax_1_2']` | `no` |
...
| `lem:one-step-drift-kernel` | `lemma` | `SemanticConvergence.Rates` | `SemanticConvergence.lem_one_step_drift_kernel` | `substantive` | `expected-native-decide-auxiliary` | `['propext', 'Classical.choice', 'Quot.sound', 'SemanticConvergence.listWeightedSum_ne_zero_exists._native.native_decide.ax_1_2']` | `no` |
...
| `lem:risk-ig` | `lemma` | `SemanticConvergence.Boundary` | `SemanticConvergence.lem_risk_ig` | `substantive` | `canonical-baseline` | `['propext', 'Classical.choice', 'Quot.sound']` | `yes` |
| `cor:efe-specialization` | `corollary` | `SemanticConvergence.Boundary` | `SemanticConvergence.cor_efe_specialization` | `substantive` | `canonical-baseline` | `['propext', 'Classical.choice', 'Quot.sound']` | `yes` |
...
| `lem:info-decomp` | `lemma` | `SemanticConvergence.Boundary` | `SemanticConvergence.lem_info_decomp` | `substantive` | `canonical-baseline` | `['propext', 'Classical.choice', 'Quot.sound']` | `yes` |
| `thm:afe-near-miss` | `theorem` | `SemanticConvergence.Boundary` | `SemanticConvergence.thm_afe_near_miss` | `substantive` | `canonical-baseline` | `['propext', 'Classical.choice', 'Quot.sound']` | `yes` |
...
| `thm:amortized-surrogate` | `theorem` | `SemanticConvergence.Surrogate` | `SemanticConvergence.thm_amortized_surrogate` | `constructive-existential` | `canonical-baseline` | `['propext', 'Classical.choice', 'Quot.sound']` | `yes` |
| `cor:amortized-surrogate-finite-time` | `corollary` | `SemanticConvergence.Surrogate` | `SemanticConvergence.cor_amortized_surrogate_finite_time` | `substantive` | `canonical-baseline` | `['propext', 'Classical.choice', 'Quot.sound']` | `yes` |
